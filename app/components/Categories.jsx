...
const Categories = ({ onCategorySelect ,selectedCategory }) => {
  ...
  return (
    ...
    //   <h2 className="py-3 flex justify-center text-secondary_color items-center font-semibold text-2xl">Categories</h2>
    //   <div className="grid lg:grid-cols-8 md:grid-cols-3 sm:grid-cols-2 grid-col-1 gap-3">
    //     {uniqueCategories.map((category, index) => (
    //       <button key={index} onClick={() => onCategorySelect(category)} className={` transition-colors duration-300 ${
