        ...
        {showFullDescription
          ...
          : description.slice(0, maxCharacters) + (description.length > maxCharacters ? "..." : "")}{description.length > maxCharacters && (
            ...
            <div className="flex justify-between mt-3">
              <button
                className={`text-white py-3 px-5 rounded ${stock > 0
                    ? "bg-primary_color"
              ...
              <Link
                ...
                target="_blank"
                className={'py-3 px-5 rounded bg-transparent text-orange-700 border-primary_color border flex items-center gap-3'}
                disabled={stock < 1}
