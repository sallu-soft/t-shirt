...
export async function generateStaticParams() {
  // Fetch all product titles to generate static params
  const {products} = await fetchProduct(); // Replace with your function to fetch all products
...
const SingleProductPage = async ({ params }) => {
  ...
  if (!product) {
    notFound(); // Return 404 page if the product is not found
  }
