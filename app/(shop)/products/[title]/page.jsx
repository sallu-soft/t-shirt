...
//    // Get available sizes and colors based on stock
...
//           {/* ... your quantity and add to cart code */}
    ...
    <section className="text-gray-600 body-font overflow-hidden">
      <div className="container flex flex-wrap px-5 py-5 md:py-24 mx-auto">
        ...
        <div className="md:w-1/2 w-2/2 lg:pl-10 lg:py-6 mt-6 lg:mt-0">
          ...
          <div className="flex">
            <button
              className={`text-white ${stock > 0 ? "bg-primary_color" : "bg-orange-200 cursor-not-allowed"}`}
              disabled={stock < 1}
              onClick={() => handleAddToCart()}
            >
              ADD TO CART
